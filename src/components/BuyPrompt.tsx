...
export const BuyPrompt: React.FC<BuyPromptProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/85 backdrop-blur-md flex items-center justify-center p-3 sm:p-4 z-50 overflow-y-auto animate-in fade-in duration-200">
      <div className="bg-[#151922]/95 border border-[#333d4e] rounded-2xl sm:rounded-3xl max-w-md w-full p-4 sm:p-6 shadow-2xl text-[#eae6da] relative my-auto max-h-[92vh] flex flex-col">
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto overscroll-contain pr-1 min-h-0 space-y-4">
          ...
          <div className="bg-[#1c222c] rounded-2xl p-4 border border-[#2b3342] space-y-2.5 shadow-inner">
        ...
        <div className="shrink-0 pt-3 border-t border-[#252c38]">
          ...
          {!isMyTurn && (
            <div className="mt-2.5 text-center text-xs text-[#848d9c] italic">
